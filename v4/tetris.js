class TetrisGame {
    ...
    toggleFullscreen() {
        ...
        if (!document.fullscreenElement && 
            ...
            // 更新按鈕文字
            document.getElementById('fullscreenButton').textContent = '退出全螢幕';
            ...
            // 更新按鈕文字
            document.getElementById('fullscreenButton').textContent = '全螢幕';
        }
    }
    ...
    adjustCanvasForFullscreen() {
        ...
        if (isMobile) {
            // 手機全螢幕模式
            const maxHeight = window.innerHeight - 250; // 留空間給控制按鈕
            const maxWidth = window.innerWidth * 0.9;
            const aspectRatio = this.BOARD_HEIGHT / this.BOARD_WIDTH;
            ...
            const blockSize = Math.floor(maxHeight / this.BOARD_HEIGHT);
            
            this.canvas.style.width = (this.BOARD_WIDTH * blockSize) + 'px';
            this.canvas.style.height = (this.BOARD_HEIGHT * blockSize) + 'px';
        }
